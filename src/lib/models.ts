...
export const models: Model[] = [
  ...
  { id: 'julia-lima', name: 'Júlia Lima', avatarImageId: 'model-julia-lima', gifImageIds: [], isOnline: false },
  { id: 'natalia-reis', name: 'Natália Reis', avatarImageId: 'model-natalia-reis', gifImageIds: [], isOnline: true },
  { id: 'vanessa-silva', name: 'Vanessa Silva', avatarImageId: 'model-vanessa-silva', gifImageIds: [], isOnline: false },
  { id: 'estela-alves', name: 'Estela Alves', avatarImageId: 'model-estela-alves', gifImageIds: [], isOnline: false },
  { id: 'bianka-gazaki', name: 'Bianka Gazaki', avatarImageId: 'model-bianka-gazaki', gifImageIds: [], isOnline: true },
  { id: 'ana-silva', name: 'Ana Silva', avatarImageId: 'model-ana-silva', gifImageIds: [], isOnline: false },
  { id: 'helena-ferreira', name: 'Helena Ferreira', avatarImageId: 'model-helena-ferreira', gifImageIds: [], isOnline: true },
  { id: 'isabella-rossi', name: 'Isabella Rossi', avatarImageId: 'model-isabella-rossi', gifImageIds: [], isOnline: false },
  ...
  { id: 'carol-moraes', name: 'Carol Moraes', avatarImageId: 'model-carol-moraes', gifImageIds: ['model-carol-moraes-gif-1'], isOnline: false },
